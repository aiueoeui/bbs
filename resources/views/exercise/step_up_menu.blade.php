      ...
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            ...
            <div class="flex justify-center mb-4">
                        <img class="rounded-lg" src="{{ asset('images/stepup_logo.PNG') }}" alt="その場足踏み"height="120px" width="220px">
            </div>
            ...
            <div class="flex flex-col">
                ...
                <div class="ml-8">
                   ...
                   <h2>せすじをのばし、しゃしんのようにひざを上げます。</h2>
                   <h2>ひざは直角になるようにしましょう。</h2>
                   <h2>1回足ぶみするのに1びょうくらいのペースでやってみましょう。</h2>
                </div>
            </div>
            </div>
...
<form method="POST" action="{{ url('/step_up') }}">
@csrf
<div class="flex">
