      ...
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            ...
            <div class="flex justify-center mb-4">
                        <img class="rounded-lg" src="{{ asset('images/kubi_logo.PNG') }}" alt=""height="120px" width="220px">
            </div>

            <div class="flex ml-4 pt-4 pb-4  border-t border-b justify-center">
            <img class="mr-2" src="{{ asset('images/kubi1.PNG') }}" alt="くび"height="120px" width="220px">
            <img src="{{ asset('images/kubi2.PNG') }}" alt="くび"height="120px" width="220px">
            ...
            <div class="flex flex-col">
                ...
                <div class="ml-8">
                   ...
                   <h2>あたまのよこをささえて、 くびをゆっくりたおしましょう。</h2>
                   <h2>左右それぞれ10びょう</h2>
                </div>
            </div>
            </div>
...
<form method="POST" action="{{ url('/kubi') }}">
@csrf
<div class="flex">
    ...
    <input type="hidden" name="exercise_name" value="くび" >
